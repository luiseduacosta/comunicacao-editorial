...
<div class="row mb-4 align-items-center">
    <div class="col-12 col-md-8">
        <h2 class="fw-bold text-dark mb-1">
            <i class="fa-solid fa-pen-to-square text-primary me-2"></i>Editar Pauta #<?= h($pauta->id) ?>
        </h2>
        <p class="text-muted mb-0">Atualize os detalhes de planejamento desta pauta.</p>
    </div>
        ...
        <div class="card main-card shadow-sm border-0">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-12">
                        <label class="form-label fw-semibold text-secondary">Anexos</label>
                        <div class="input-group">
